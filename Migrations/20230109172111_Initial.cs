    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TaxIdentificationNumber = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AddedTimestamp = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BudgetPositions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BudgetPositions_Bands_BandId",
                        column: x => x.BandId,
                        principalTable: "Bands",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BudgetPositions_Events_EventId",
                        column: x => x.EventId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GearItems_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GearItems_Bands_BandId",
                        column: x => x.BandId,
                        principalTable: "Bands",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GearItems_Events_RentalId",
                        column: x => x.RentalId,
                        principalTable: "Events",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GearItems_Events_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetPositions_BandId",
                table: "BudgetPositions",
                column: "BandId");

            migrationBuilder.CreateIndex(
                name: "IX_BudgetPositions_EventId",
                table: "BudgetPositions",
                column: "EventId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GearItems_RentalId",
                table: "GearItems",
                column: "RentalId");

            migrationBuilder.CreateIndex(
                name: "IX_GearItems_ServiceId",
                table: "GearItems",
                column: "ServiceId");
        }
